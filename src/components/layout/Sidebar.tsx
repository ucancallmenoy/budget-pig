...
const quickLinks = [
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m3-12.5a2.5 2.5 0 00-2.5-1.5h-1a2.5 2.5 0 000 5h1a2.5 2.5 0 010 5h-1A2.5 2.5 0 019 14.5" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14l2 2 4-4m5 2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2v-4" />
      </svg>
    ),
  },
  {
            ...
            <div className="space-y-1">
              {isLoading ? (
                ...
                currentYear && currentMonth && quickLinks.map((link) => {
                  const href = `/dashboard/${currentYear}/${currentMonth}`;
                  const isLinkActive = pathname.includes(`/${link.path}/`);
